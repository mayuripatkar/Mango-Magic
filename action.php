	...
	if(mysqli_num_rows($run_query) > 0){
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
                    ...
                    <div type='button' c
                    ss='btn navbar-btn category' cid='$cid'>
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Never miss the taste of Mango Anytime!High in fibre,protein rich.</p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@mayuri.com">
